...
execute unless data entity @s {Inventory:[]} run scoreboard players operation @s Stage = @s Trigger
execute unless data entity @s {Inventory:[]} run function stage:move/create
