execute if entity @s[tag=InitialPlace,tag=!Initialized] run function trap:initial_place/init
...
execute if entity @s[tag=Arrow,type=arrow] run function player:bow/arrow
