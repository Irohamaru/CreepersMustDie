...
execute at 0-0-0-0-0 run summon minecraft:armor_stand ~ ~ ~ {Tags:[Arrow,Trap],Team:Red,Invisible:1b,Marker:1b,Passengers:[{id:"minecraft:item_display",Tags:[Arrow,Trap],Team:Red,item:{id:"minecraft:carrot_on_a_stick",Count:1b,components:{"minecraft:custom_model_data":31}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[2.1f,2.1f,2.1f],translation:[0f,1f,1f]}}]}
