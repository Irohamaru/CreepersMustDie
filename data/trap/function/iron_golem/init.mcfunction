...
attribute @e[tag=IronGolem,distance=0,limit=1] minecraft:max_absorption base set 2048
data merge entity @e[tag=IronGolem,distance=0,limit=1] {Team:"Friendly",DeathLootTable:"minecraft:empty",Health:100f,AbsorptionAmount:2048f,PlayerCreated:1b,active_effects:[{id:"minecraft:regeneration",amplifier:1b,duration:2100000000,show_particles:0b}],attributes:[{Name:"minecraft:minecraft:max_health",Base:100},{Name:"minecraft:minecraft:follow_range",Base:6},{Name:"minecraft:minecraft:movement_speed",Base:0.1},{Name:"minecraft:minecraft:attack_damage",Base:50}]}
