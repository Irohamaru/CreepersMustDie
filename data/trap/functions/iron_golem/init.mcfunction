...
data merge entity @e[tag=IronGolem,distance=0,limit=1] {Team:"Friendly",DeathLootTable:"minecraft:empty",Health:100f,AbsorptionAmount:1000000f,PlayerCreated:1b,active_effects:[{id:"minecraft:regeneration",amplifier:1b,duration:2100000000,show_particles:0b}],Attributes:[{Name:"minecraft:generic.max_health",Base:100},{Name:"minecraft:generic.follow_range",Base:6},{Name:"minecraft:generic.movement_speed",Base:0.1},{Name:"minecraft:generic.attack_damage",Base:50}]}
