...
data modify entity @s[scores={HP=11..20}] ArmorItems[3].tag.CustomModelData set value 51
data modify entity @s[scores={HP=1..10}] ArmorItems[3].tag.CustomModelData set value 52
