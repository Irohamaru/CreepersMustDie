...
execute store result score # _ run data get entity @s Pose.Head[0]
...
execute store result entity @s Pose.Head[0] float 1 run scoreboard players get # _
execute store result entity @s Rotation[1] float 1 run scoreboard players get # _

execute if score @s Interval matches 50 rotated ~ 0 run particle item polished_blackstone ^ ^1.5 ^-2.5 1 0 1 0 5 force
execute if score @s Interval matches 120 rotated ~ 0 run particle item polished_blackstone ^ ^1.5 ^2.5 1 0 1 0 5 force

execute if score @s Interval matches 1..50 anchored eyes at @s facing ^ ^ ^-1 positioned ^ ^-2.5 ^ run function trap:swing_mace/attack
execute if score @s Interval matches 71..120 anchored eyes at @s positioned ^ ^-2.5 ^ run function trap:swing_mace/attack
