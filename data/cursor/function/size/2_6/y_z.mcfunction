...
execute if score #Success _ matches 12 run particle dust{color:[0,1,0],scale:0.5} ~ ~ ~3 0.5 0 0 1 12 force @s
execute if score #Success _ matches 12 run particle dust{color:[0,1,0],scale:0.5} ~ ~ ~-3 0.5 0 0 1 12 force @s
execute if score #Success _ matches 12 run particle dust{color:[0,1,0],scale:0.5} ~1 ~ ~ 0 0 1.5 1 20 force @s
execute if score #Success _ matches 12 run particle dust{color:[0,1,0],scale:0.5} ~-1 ~ ~ 0 0 1.5 1 20 force @s

execute unless score #Success _ matches 12 run particle dust{color:[1,0,0],scale:0.5} ~ ~ ~3 0.5 0 0 1 12 force @s
execute unless score #Success _ matches 12 run particle dust{color:[1,0,0],scale:0.5} ~ ~ ~-3 0.5 0 0 1 12 force @s
execute unless score #Success _ matches 12 run particle dust{color:[1,0,0],scale:0.5} ~1 ~ ~ 0 0 1.5 1 20 force @s
execute unless score #Success _ matches 12 run particle dust{color:[1,0,0],scale:0.5} ~-1 ~ ~ 0 0 1.5 1 20 force @s
