...
execute if score #Success _ matches 1 if data storage item: Item.tag{Face:[Ceil]} positioned ~ ~-0.25 ~ run function cursor:tp
execute if score #Success _ matches 1 unless data storage item: Item.tag{Face:[Ceil]} run function cursor:tp
