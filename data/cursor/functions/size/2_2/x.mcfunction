...
execute if score #Success _ matches 4 run particle dust 0 1 0 0.5 ~ ~ ~1 0 0.5 0 1 12 force @s
execute if score #Success _ matches 4 run particle dust 0 1 0 0.5 ~ ~ ~-1 0 0.5 0 1 12 force @s
execute if score #Success _ matches 4 run particle dust 0 1 0 0.5 ~ ~1 ~ 0 0 0.5 1 12 force @s
execute if score #Success _ matches 4 run particle dust 0 1 0 0.5 ~ ~-1 ~ 0 0 0.5 1 12 force @s

execute unless score #Success _ matches 4 run particle dust 1 0 0 0.5 ~ ~ ~1 0 0.5 0 1 12 force @s
execute unless score #Success _ matches 4 run particle dust 1 0 0 0.5 ~ ~ ~-1 0 0.5 0 1 12 force @s
