...
execute unless data entity @s SelectedItem run scoreboard players add @s TrapRotation 1
execute unless data entity @s SelectedItem run scoreboard players set @s[scores={TrapRotation=4..}] TrapRotation 0
