...
execute if score # _ matches 1 if score @s Interval matches ..0 if data storage stage: Detour[0] as 0-0-0-0-1 on origin if entity @s[tag=!Detour] run function mob:ai/route/stack/near_barricade/detour
