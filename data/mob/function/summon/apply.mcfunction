data modify entity @s attributes[{Name:"minecraft:minecraft:follow_range"}].Base set from storage mob: FollowRange
data modify entity @s attributes[{Name:"minecraft:minecraft:movement_speed"}].Base set from storage mob: MovementSpeed
data modify entity @s attributes[{Name:"minecraft:minecraft:attack_damage"}].Base set from storage mob: Damage
data modify entity @s attributes[{Name:"minecraft:minecraft:knockback_resistance"}].Base set from storage mob: KnockbackResistance
...
execute if entity @s[tag=Float] positioned ~ ~-50 ~ run attribute @e[type=wandering_trader,distance=0,limit=1] minecraft:scale base set 0.5
