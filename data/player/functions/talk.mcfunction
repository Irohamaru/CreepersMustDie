...
tellraw @s [{"text":""},{"selector":"@e[tag=TalkingVillager,distance=..7,limit=1,sort=nearest]","color":"yellow"},{"text":": "},{"entity":"@e[tag=TalkingVillager,distance=..7,limit=1,sort=nearest]","nbt":"ArmorItems[3].components.minecraft:custom_data.Talk","interpret":true}]
